...
### 🔍 `/add-code-reviews-to-task` - Convert AI code reviews to tasks

```bash
/add-code-reviews-to-task [code reviews content]  # Process provided reviews directly
```

Critically evaluates AI-generated code reviews, filters out hallucinated or generic feedback, and creates actionable tasks from valid reviews.
