...
Outline-Driven Development, nicknamed ODIN, is a highly opinionated code-agent skill library: principles-first
...
marketplace ships at one `releaseVersion`, currently 2.1.2, held in `catalog/plugins.json`.
