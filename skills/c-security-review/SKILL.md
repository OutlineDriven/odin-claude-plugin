...
description: 'Use when the user requests a complete userspace C or C++ security review with an explicit threat model, severity filter, model, and optional scope; the skill runs a measured location-partitioned audit with a checkable coverage ledger and writes a severity-grouped report, SARIF, findings, and a coverage gate to a .c-review-results run directory. Don''t use for remote, credential, publish, deploy, or irreversible changes.'
---
