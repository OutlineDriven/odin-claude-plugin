...
description: 'Use when two colleagues'' working friction needs trait-based explanation, accommodations, process changes, and escalation boundaries. Returns a trait-gap map, reciprocal perspectives, person-specific accommodations, process changes, conversation guide, and escalation criteria. Don''t use for tasks that require source or remote-system changes.'
---
