...
- Origin: https://github.com/obra/superpowers — `docs/superpowers/specs/2026-06-10-positive-instruction-redesign-design.md`
- Pinned revision: b36e0829c6d0140e93cfef2ca599b1b07d4a7797
- License: MIT, Copyright 2025 Jesse Vincent
- Adaptation: clean-room adaptation of the per-sentence phrasing micro-test method and four-category negative-instruction doctrine. The source spec's writing-plans case study and audit results are reference material only; this skill encodes the generalizable measurement procedure, not any specific instruction rewrite.
