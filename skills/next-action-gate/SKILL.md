...
description: 'Use when a task needs an evidence-based PASS, DELAY, or BLOCK status and a separate next-action permission. Produces Evidence-backed task status and next-action permission. Stop at the declared success, non-success, or bound.'
---
...
2. Execute the Evidence-backed task status and next-action permission inside the bound.
