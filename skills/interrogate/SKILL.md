...
- Origin: `cursor/plugins`, pstack/skills/interrogate, authored by Lauren Tan (poteto).
- Revision: `68836ddaf5697224520f1847d90cdb90ca8babaa`.
- License: MIT — evidence: pstack/LICENSE blob `6b5400237fdf6545be0b8fae370d6f2fcff8fb25` (1067 bytes); pstack authored by Lauren Tan under MIT per audit license block.
- Adaptation: Clean-room ODIN 2.0 rewrite of the adversarial multi-model review mechanism. Procedure restructured to ODIN contract format. Lead judgment synthesis pattern and agreement map structure retained as load-bearing mechanisms.
