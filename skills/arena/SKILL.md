---
name: arena
description: 'Use when asked to generate and judge competing artifact implementations. Produce one verified synthesis with provenance and rejection reasons. Don''t use for remote, credential, publish, deploy, or irreversible changes.'
---
...
|---|---|
| Trigger | Generate and judge competing artifact implementations. |
