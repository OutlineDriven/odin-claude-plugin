...
|---|---|
| Trigger | User asks to enhance, improve, audit, or tighten a plugin config, agent definition, skill, CLAUDE.md/AGENTS.md, docs, prompt, command, or hook surface. |
...
| Done | Enhancement report produced with all HIGH findings complete in default output, MEDIUM/LOW shown only under --verbose, and under --apply each HIGH finding removed without new HIGH issues. |
