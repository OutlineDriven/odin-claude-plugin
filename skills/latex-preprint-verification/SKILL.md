...
description: 'Use when source material needs a traceable compiling LaTeX preprint without fabricated claims. Produces Traceable native-visual LaTeX preprint. Stop at the declared success, non-success, or bound.'
---
...
2. Execute the Traceable native-visual LaTeX preprint inside the bound.
