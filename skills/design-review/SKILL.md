---
name: design-review
description: 'Use when the user runs /design-review with a URL to visually audit a live UI through the browser and fix findings in a screenshot-verified loop. Not for design direction picking — use design; not for variant galleries — use design-variants.'
---
...
1. Create a report directory `design-audit-<YYYYMMDD>/screenshots/`. **Done when:** the report directory and screenshots subfolder exist.
