...
description: 'Use when an authorized reference surface needs a clean-room frontend reconstruction. Produces Authorized frontend reconstruction across static, motion, and responsive fidelity. Stop at the declared success, non-success, or bound.'
---
...
3. Execute the Authorized frontend reconstruction across static, motion, and responsive fidelity inside the bound.
