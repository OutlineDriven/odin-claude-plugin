---
name: embed-diagram
description: 'Use when the user runs /embed-diagram to render a mermaid diagram offline and embed the SVG or PNG into a target document. Not for code-derived diagrams — use diagramming-code. No remote, credential, publish, deploy, or irreversible changes.'
---
...
|---|---|
| Trigger | the user runs `/embed-diagram` |
