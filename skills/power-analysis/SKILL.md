---
name: power-analysis
description: 'Use when a two-arm comparison needs sample sizing and validity review before data collection. Produces Preregistered two-arm sample-size design. Stop at the declared success, non-success, or bound.'
---
...
2. Execute the Preregistered two-arm sample-size design inside the bound.
