...
description: 'Use when a user asks to clean up, sync, dedupe, de-noise, or rewrite an iterated artifact. Rewrites the artifact as a clean v0 with no patch traces, changelog scars, or source noise. Don''t use for remote, credential, publish, deploy, or irreversible changes.'
---
