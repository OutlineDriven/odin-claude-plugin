...
description: 'Use when reviewing Django or DRF access control, IDOR, authorization, permissions, or tenant isolation. Returns validated access-control findings with evidence, impact, and enforcing fix suggestions. Don''t use for tasks that require source or remote-system changes.'
---
