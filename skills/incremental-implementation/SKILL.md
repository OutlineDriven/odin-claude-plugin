...
- Origin: addyosmani/agent-skills, `skills/incremental-implementation/SKILL.md`.
- Pinned revision: d2c37ef6225dd8726cdd369a8030307f48592d26.
- License: MIT. Copyright (c) 2025 Addy Osmani. Retain copyright notice and MIT permission text in derived distributions.
- Adaptation: ADAPT into odin-code. Thin vertical slices each leaving the system working and testable. No retained ODIN contract was proven to subsume this content, so it is adapted as a standalone procedure rather than merged.
