...
description: 'Use when asked to predict Culture Index traits from an interview transcript before a survey exists. Also handles uncertain traits when evidence is sparse or contradictory. Not for interpreting survey results — use culture-individual-interpretation.'
---
