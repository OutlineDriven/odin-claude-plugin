---
name: goal-contract
description: 'Use when a goal or product contract needs complete requirement provenance, done evidence, and pre-build convergence. Produces Implementation-ready requirement-to-evidence goal contract. Stop at the declared success, non-success, or bound.'
---
...
3. Execute the Implementation-ready requirement-to-evidence goal contract inside the bound.
