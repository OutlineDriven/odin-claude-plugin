---
name: orchestrate
description: 'Use when a human explicitly requests orchestration of a large task across cloud agents to drain a verified task graph. Not for local subagent coordination — use orchestration-patterns.'
