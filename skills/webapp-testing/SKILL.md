---
name: webapp-testing
description: 'Use when asked to verify frontend functionality, debug UI behavior, capture browser screenshots, or inspect browser logs. Runs Playwright test scripts, captures evidence, and verifies UI behavior locally. Don''t use for remote, credential, publish, deploy, or irreversible changes.'
---
...
6. If the script exits zero, the done predicate holds. Proceed to the Output section. Done when: pass verdict is confirmed.
