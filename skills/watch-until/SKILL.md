---
name: watch-until
description: 'Use when asked to poll a named changing job, log, or artifact until a supplied completion predicate holds. Returns a terminal completion verdict — predicate-holds or non-converged. Not for source or remote-system changes. Not for continuous anomaly monitoring — use watch-for.'
---
