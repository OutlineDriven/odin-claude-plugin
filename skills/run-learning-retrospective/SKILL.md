...
| Done | Retrospective, adjusted plan, and measurable next milestone. |
...
8. Assemble the retrospective report per the Output section.
...
- **No existing plan**: proceed with the retrospective using the milestone and evidence alone. Propose an initial plan as part of the adjusted plan output.
- **Conflicting evidence**: surface the conflict, state both interpretations, and ask the learner to clarify before finalizing the retrospective.
- **Scope creep detected**: if the review expands beyond the stated milestone, stop and report that the scope has widened. Recommend a separate retrospective for the additional scope.

## Output
A retrospective report containing:
