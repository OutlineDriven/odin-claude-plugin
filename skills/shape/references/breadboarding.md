...
The breadboard answers "what connects to what" and "what can the user do here" while every visual question — layout, columns, wording — stays open.

## Fat-marker rules

Sketch with a marker too thick for detail. If the tool lets you draw a table's columns, you are zoomed in too far. One sketch per idea; a sketch that needs a legend is over-drawn.
