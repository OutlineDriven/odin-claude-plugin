---
name: cascade-dedup
description: 'Use when prompt-doctrine is duplicated, drifted, or conflicting across output-style embeds and external harness AGENTS files. Strips duplicate directives, repairs invariant-zone drift, and records a divergence ledger. Not for editing the canonical baseline itself.'
