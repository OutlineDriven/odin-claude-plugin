...
description: 'Use when the user asks whether property-based testing fits a code path, which property and library to choose, or whether an existing design exposes a meaningful property. Delivers a read-only verdict naming the strongest non-vacuous property, its domain and strategy seam, and a project-consistent library — or a reasoned decline to example tests. Don''t use for tasks that require source or remote-system changes.'
---
