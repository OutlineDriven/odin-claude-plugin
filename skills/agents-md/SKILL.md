...
- Merged from agents-md-curation: Origin mcollina/skills, revision 856efd268ae85482d882f3d0bed869fd020b5c06, license MIT. The discoverability survey, three-check admission gate (non-discoverable, operationally significant, actionable), imperative-with-rationale form, omission set, hierarchical recommendation, and maintenance mindset were folded into the refactor step and procedure intro. Third-party license obligations: see root PROVENANCE.md.
- Merged from lean-agents-md: Origin getsentry/skills (Apache-2.0), revision c2f99a5b04b4cd992ec3022d7c2c3e23e938d241. The pointer-only section format, 100-line limit, commit attribution line, and empty-conventions fallback were folded into the writing step as a lean variant. Adaptation is clean-room: contract reconstructed from normalized candidate metadata; no third-party expression copied.
