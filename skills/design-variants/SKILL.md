...
description: 'Use when /design-variants generates distinct design directions and a gallery for selection. Not for one polished artifact — use design-prototype; not for token-system direction picking — use design. No remote, credential, publish, deploy, or irreversible changes.'
---
