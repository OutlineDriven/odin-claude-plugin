---
name: plan
description: Read-only architecture and implementation planning. Use proactively before non-trivial code changes when the approach is unclear, multiple alternatives need weighing, or cross-file impact is uncertain. Do not invoke for typo fixes or single-line edits.
