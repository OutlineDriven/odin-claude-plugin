---
name: mlops-engineer
description: Build ML pipelines, experiment tracking, and model registries. Implements MLflow, Kubeflow, and automated retraining. Use PROACTIVELY for ML infrastructure, experiment management, or pipeline automation.
---
