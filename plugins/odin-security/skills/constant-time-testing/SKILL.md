...
description: 'Use when a cryptographic implementation must be checked at runtime for timing side-channel leakage. Not for static inspection: use constant-time-analysis.'
---
