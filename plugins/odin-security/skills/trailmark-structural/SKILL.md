...
description: 'Use when a target needs a single-snapshot structural analysis: hotspots, entrypoints, taint, blast radius, privilege boundaries, proxies, subgraphs. Not for a quick overview: use trailmark-summary.'
---
