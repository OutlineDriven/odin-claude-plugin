...
description: 'Use when changes touch auth, parsing, dependencies, network, or public-service pre-release. Not for adding controls, use security-hardening. Not for one finding, use security-finding-verification.'
---
