---
name: variant-hunt
description: 'Use when a confirmed root cause must be searched across a codebase or turned into a search rule. Not for graph-neighborhood seeding: use variant-neighborhood-seeding.'
---
