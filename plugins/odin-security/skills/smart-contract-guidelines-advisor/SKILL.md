...
description: 'Use when a smart contract needs architecture, implementation, dependency, or testing guidance. Not for maturity or audit prep: use smart-contract-code-maturity-assessor / smart-contract-audit-prep.'
---
