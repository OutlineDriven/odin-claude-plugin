...
description: 'Use when a vulnerability or pattern and target language need a new Semgrep rule. Not for porting a rule: use port-static-analysis-rule. Not for running scans: use semgrep-security-scan.'
---
