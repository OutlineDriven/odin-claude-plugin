...
| Authority | Remote: posts one comment on a GitHub issue requesting missing information; requires explicit human invocation. Preview the comment text and target issue before posting. Do not label, close, or otherwise mutate the issue or repository without explicit human action. |
