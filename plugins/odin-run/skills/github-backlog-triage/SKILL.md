...
2. **Gather issues and context.** Fetch open issues, open PRs, and recently merged PRs: Done when: the stated action, evidence, and guard all hold.
   ```bash
