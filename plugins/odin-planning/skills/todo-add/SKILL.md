---
name: todo-add
description: 'Add a requirement from `TODO ADD: <text>` to the durable source and native todo in the same turn. Not for deepening coarse task lists — use todos-enhance; not for re-syncing stale lists — use todos-update; not for retitling, reordering, or completing existing todos.'
---
