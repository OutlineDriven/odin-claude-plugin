...
4. **Advantage and compounding**: choices that, once made, make many future moves cheaper or stronger; second-order effects.
...
- Bias toward the basis type your frame naturally produces: pain/inversion/advantage tend toward `direct:`; analogy and constraint-flipping tend toward `reasoned:`; assumption-breaking is mixed: but don't exclude other basis types.
...
5. Spread ideas across multiple dimensions when justified: workflow/DX, reliability, extensibility, missing capabilities, docs/knowledge compounding, quality/maintenance, payoff for future work.
