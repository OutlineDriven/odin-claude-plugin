...
| Authority | Reversible local: writes only `workflows/*.md` and `NOTES.md`; rollback is restoring prior content or removing newly created files. No remote mutation. |
