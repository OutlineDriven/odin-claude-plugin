...
| Authority | Remote: creates GitHub issues and writes local ticket files; requires explicit human invocation, presenting the complete draft, exact targets, and consequence of publishing before proceeding. |
