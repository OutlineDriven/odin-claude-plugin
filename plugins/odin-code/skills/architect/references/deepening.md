...
How to deepen a cluster of shallow modules safely, given its dependencies. Assumes the vocabulary in `skills/architect/SKILL.md`: module, interface, seam, adapter.
