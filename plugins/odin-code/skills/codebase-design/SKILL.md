...
description: 'Use when designing or improving a module interface, locating a seam, or increasing testability. Not for system-level architecture decisions: use architect.'
---
