...
- Render or atomic-delivery check failure: the artifact does not render the full requested movement, or one deliverable is incomplete. Fix and re-run both checks; a partial pass is not done.
