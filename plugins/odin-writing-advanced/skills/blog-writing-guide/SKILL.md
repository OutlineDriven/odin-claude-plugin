...
description: 'Use when asked to write, review, or improve a Sentry engineering blog post. Produces blog copy with a real byline, no corporate fluff, real numbers, working code, and a shareable story. Not for remote, credential, publish, deploy, or irreversible changes.'
---
