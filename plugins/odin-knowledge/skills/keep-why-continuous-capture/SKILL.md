...
| Authority | Reversible local: writes only one named topic file and one index line in the configured context directory; rollback is undo. No remote mutation. |
