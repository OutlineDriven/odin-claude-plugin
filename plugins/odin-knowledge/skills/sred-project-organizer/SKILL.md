...
| Authority | Human-gated: requires explicit human confirmation before creating any child document; every other write is reversible local, with version control as the rollback. |
