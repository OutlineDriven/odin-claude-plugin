...
| Authority | Reversible local: runs diagnostic binaries and writes only a diagnosis report; rollback is deleting the report. Does not modify code or restart services. No remote mutation. |
