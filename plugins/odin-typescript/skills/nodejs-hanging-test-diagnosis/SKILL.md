...
| Authority | Reversible local: runs test binaries under timeouts and reporters and writes only test and teardown code in this repository; rollback is version control. No remote mutation. |
