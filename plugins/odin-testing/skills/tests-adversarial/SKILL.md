...
| Done | Every documented assumption has a violation test, every failure path produces a descriptive error, and the selected sanitizers pass with zero warnings, or unsupported sanitizer gaps are recorded. |
