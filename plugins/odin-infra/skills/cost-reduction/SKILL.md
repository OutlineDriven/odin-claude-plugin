...
2. Pre-register each proposed cost-reduction change (the rung): name it, state the mechanism, expected dollar leverage, and every judgment point it moves to a cheaper tier. **Done when:** the rung is pre-registered with name, mechanism, leverage, and every judgment point enumerated.
