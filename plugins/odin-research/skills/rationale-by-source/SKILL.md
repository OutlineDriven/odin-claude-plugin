...
description: 'Use when asked to investigate design rationale, regression causes, or thresholds via source playbooks. Not for why-style decision rationale from conversation context: use why.'
---
