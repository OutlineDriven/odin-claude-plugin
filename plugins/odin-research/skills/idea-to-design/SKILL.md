---
name: idea-to-design
description: 'Use when the user runs /idea-to-design with an idea or repository. Develop the idea into a redaction-checked design document and hand it off with a tiered closing and next-skill offer. Don''t use for remote, credential, publish, deploy, or irreversible changes.'
---
...
|---|---|
| Trigger | the user runs /idea-to-design with an idea or repository |
