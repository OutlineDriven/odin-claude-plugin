...
| Authority | Reversible local: writes only ./research/{type}-{topic}-{date}.md and an optional PDF beside it; rollback is version control or undo. No remote mutation. Spawns 3-20 read-only sub-agents. |
