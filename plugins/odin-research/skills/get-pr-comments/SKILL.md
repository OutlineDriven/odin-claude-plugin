...
3. Classify every comment into a severity tier: blocking (change requested or unresolved thread marked blocking), suggestion, nit, or question. Done when: every comment is classified into a tier.
