...
Not for architecture diagrams — use architecture-diagram. Not for deploy, remote, credential, publish, or irreversible changes — use deploy or shipping skills. Not for people-process or organizational architecture.
...
5. **If the user requests interface alternatives, dispatch the design-twice parallel passes** described in `references/interface-design.md`. Done when: the two designs are compared and differences resolved.
