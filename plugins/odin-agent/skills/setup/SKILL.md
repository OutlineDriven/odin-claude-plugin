...
| Authority | Human-gated: asks before each credential write, `.venv` creation, or placeholder replacement in skill scripts; every other write is reversible local, with version control as the rollback. |
