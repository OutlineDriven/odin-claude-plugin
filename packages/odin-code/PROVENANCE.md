# Provenance — @outlinedriven/odin-code
...
|---|---|---|---|---|
| `api-and-interface-design` | B | byte-reuse | `skills/api-and-interface-design/` | addyosmani/agent-skills @ `d2c37ef6225dd8726cdd369a8030307f48592d26` (MIT) |
| `ast-grep` | B | byte-reuse | `skills/ast-grep/` | odin-1.x-current-skill @ `project-owned` (Project-owned or clean-room only; no copied source text) |
...
| `offense` | B | byte-reuse | `skills/offense/` | odin-1.x-current-skill @ `project-owned` (Project-owned or clean-room only; no copied source text) |
| `package-native-pre-commit` | B | byte-reuse | `skills/package-native-pre-commit/` | mattpocock/skills @ `6654f6b60cd9d5be8b54c6fafe44346dabeb3b76` (MIT) |
| `planning-and-task-breakdown` | B | byte-reuse | `skills/planning-and-task-breakdown/` | addyosmani/agent-skills @ `d2c37ef6225dd8726cdd369a8030307f48592d26` (MIT) |
...
| `review-speedread` | B | byte-reuse | `skills/review-speedread/` | project-owned:user-curated-skill-ideas @ `project-owned` (Project-owned or clean-room only; no copied source text) |
| `run-smoke-tests` | B | byte-reuse | `skills/run-smoke-tests/` | cursor/plugins @ `68836ddaf5697224520f1847d90cdb90ca8babaa` (MIT) |
| `sarif-parsing` | B | byte-reuse | `skills/sarif-parsing/` | https://github.com/trailofbits/skills @ `d1f1575cff97816e5cc08af66cd2506099c681d3` (CC-BY-SA-4.0; source https://github.com/trailofbits/skills/tree/d1f1575cff97816e5cc08af66cd2506099c681d3; preserve Trail of Bits attribution and source link, mark modifications, license adaptations ShareAlike, claim no trademark rights, and never reuse trail-of-bits-mark.svg as branding.) |
| `setup-gitignore` | B | byte-reuse | `skills/setup-gitignore/` | odin-current @ `project-owned` (Project-owned or clean-room only; no copied source text) |
| `setup-pre-commit` | B | byte-reuse | `skills/setup-pre-commit/` | odin-current @ `project-owned` (Project-owned or clean-room only; no copied source text) |
| `simplify` | G | structured-merge-rewrite | `skills/simplify/` | current-odin-skill-tree @ `project-owned` (Project-owned or clean-room only; no copied source text) |
...
| `type-driven` | B | byte-reuse | `skills/type-driven/` | current-odin-skill-tree @ `project-owned` (Project-owned or clean-room only; no copied source text) |
| `universal-invariant-baseline` | B | byte-reuse | `skills/universal-invariant-baseline/` | project-owned:user-curated-skill-ideas @ `project-owned` (Project-owned or clean-room only; no copied source text) |
| `validate-changes-match-specs` | B | byte-reuse | `skills/validate-changes-match-specs/` | https://github.com/warpdotdev/common-skills @ `f589e224907eda566c13755529f59db563090d14` (MIT) |
| `visual-diff-review` | B | byte-reuse | `skills/visual-diff-review/` | nicobailon/visual-explainer @ `7163c3e10660912e0b89e1af465db9f387282b88` (MIT) |
| `worktree` | G | structured-merge-rewrite | `skills/worktree/` | current-odin-skill-tree @ `project-owned` (Project-owned or clean-room only; no copied source text) |
