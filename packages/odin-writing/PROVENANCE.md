# Provenance — @outlinedriven/odin-writing
...
|---|---|---|---|---|
| `articulate` | N | genuine-new-rewrite | `skills/articulate/` | project-owned; genuine-new rewrite; no third-party source |
| `brand-authority` | M | move-only | `skills/brand-authority/` | https://github.com/warpdotdev/common-skills @ `f589e224907eda566c13755529f59db563090d14` (MIT) |
| `brand-guidelines` | M | move-only | `skills/brand-guidelines/` | getsentry/skills @ `c2f99a5b04b4cd992ec3022d7c2c3e23e938d241` (Apache-2.0) |
| `copywriting` | M | move-only | `skills/copywriting/` | mblode/agent-skills @ `e97a3b383f5944f90d41eb92b24b4fb3b917a7f9` (MIT) |
| `copywriting-cta` | M | move-only | `skills/copywriting-cta/` | samber/cc-skills @ `f9953962e135235137628ea92d06ea085688031f` (MIT) |
| `copywriting-hooks` | M | move-only | `skills/copywriting-hooks/` | samber/cc-skills @ `f9953962e135235137628ea92d06ea085688031f` (MIT) |
| `humaniseur-fr` | M | move-only | `skills/humaniseur-fr/` | samber/cc-skills @ `f9953962e135235137628ea92d06ea085688031f` (MIT) |
