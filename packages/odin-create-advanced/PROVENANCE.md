# Provenance — @outlinedriven/odin-create-advanced
...
| `from-first-principle` | B | byte-reuse | `skills/from-first-principle/` | project-owned:user-curated-skill-ideas @ `project-owned` (Project-owned or clean-room only; no copied source text) |
| `fromzero` | B | byte-reuse | `skills/fromzero/` | project-owned:user-curated-skill-ideas @ `project-owned` (Project-owned or clean-room only; no copied source text) |
| `journey-trace-wizard` | B | byte-reuse | `skills/journey-trace-wizard/` | mattpocock/skills @ `6654f6b60cd9d5be8b54c6fafe44346dabeb3b76` (MIT) |
...
| `scaffold-exercises` | B | byte-reuse | `skills/scaffold-exercises/` | mattpocock/skills @ `6654f6b60cd9d5be8b54c6fafe44346dabeb3b76` (MIT) |
| `single-file-html-deck` | B | byte-reuse | `skills/single-file-html-deck/` | getsentry/skills @ `c2f99a5b04b4cd992ec3022d7c2c3e23e938d241` (Apache-2.0) |
| `snippet-image-rendering` | B | byte-reuse | `skills/snippet-image-rendering/` | mcollina/skills @ `856efd268ae85482d882f3d0bed869fd020b5c06` (MIT) |
| `tasty-abstraction` | B | byte-reuse | `skills/tasty-abstraction/` | project-owned:user-curated-skill-ideas @ `project-owned` (Project-owned or clean-room only; no copied source text) |
| `training-report` | B | byte-reuse | `skills/training-report/` | samber/cc-skills @ `f9953962e135235137628ea92d06ea085688031f` (MIT) |
| `visual-slides` | B | byte-reuse | `skills/visual-slides/` | nicobailon/visual-explainer @ `7163c3e10660912e0b89e1af465db9f387282b88` (MIT) |
| `visualise-explainer` | B | byte-reuse | `skills/visualise-explainer/` | https://github.com/bentossell/visualise @ `35cd185b58af5db2f9d0fe13d9872b544a467483` (MIT) |
| `waterfall-guide` | B | byte-reuse | `skills/waterfall-guide/` | project-owned:user-curated-skill-ideas @ `project-owned` (Project-owned or clean-room only; no copied source text) |
