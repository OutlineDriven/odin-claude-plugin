...
WHEN brainstorm / option-surfacing needed: invoke brainstorming [brainstorm]
WHEN proof-of-correctness needed: invoke proof-driven [proof]
WHEN type-driven design clarifies invariants: invoke type-driven [types]
WHEN debugging / root-cause-isolation needed: invoke systematic-debugging [debug]
WHEN Opus 4.7 thinking-omitted display: user-visible output carries concise evidence/rationale trace; hidden reasoning NOT exposed [thinking-display]
