...
<languages>
**General:** Immutability-first | Zero-copy hot paths | Fail-fast typed errors | Strict null-safety | Exhaustive matching | Code style + quality standard: Jane Street house style (archived: web.archive.org/web/20251116120403/https://opensource.janestreet.com/standards/); its language-agnostic rules (naming, signatures, defensive programming, tests) apply everywhere. Per-language blocks below win on formatting and toolchain.
